...
export default function App() {
  ...
  return <BrowserRouter><Toaster position="top-center"/><Routes><Route element={<AuthGate />}><Route element={<Layout />}>
    ...
    <Route element={<ProtectedRoute permission="properties" />}><Route path="properties" element={<Properties />} /><Route path="matching" element={<Matching />} /></Route>
    <Route element={<ProtectedRoute permission="settings" />}><Route path="settings" element={<Settings />} /><Route path="backup" element={<Backup />} /></Route>
    <Route element={<ProtectedRoute permission="users" />}><Route path="users" element={<Users />} /></Route>
